...
pawn_moves = "Пешка ходит вперед на одну клетку, а рубит по диагонали налево и направо. В свой первый ход может походить на две клетки вперед"
king_moves = "Король ходит на одну клетку во все стороны"
queen_moves = "Королева ходит на любое количество клеток во все стороны"
bishop_moves = "Слон ходит по диагонали на любое количество клеток"
knight_moves = "Конь ходит буквой Г"
rook_moves = "Ладья ходит по горизонтали и вертикали на любое количество клеток"
...
bad_question = "Я не знаю ответа на этот вопрос"
